package com.biocap.app.data.sensor.watch
 ...
 * [com.biocap.app.data.repository.ConnectionRepository] observe the exposed flows.
 *
...
class WatchSensorReceiver @Inject constructor(
     ...
     * ([com.biocap.app.data.recording.ScenarioRecordingRepositoryImpl] via `timeProvider.nowMs()`).
