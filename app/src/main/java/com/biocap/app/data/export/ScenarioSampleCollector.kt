 ...
 * [com.biocap.app.data.export.upload.SessionUploadMapper]: pull each scenario's samples once and
 * count them per [SensorType].
 *
 * Both mappers derive their `statistics` block from the samples they actually emit (never from
 * [com.biocap.app.data.db.SessionEntity]'s stored counters, which can lag — e.g. a scenario that
